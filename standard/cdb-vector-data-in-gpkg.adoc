:Title: Volume 13: OGC CDB Rules for Encoding CDB Vector Data using GeoPackage (Normative, Optional Extension).
:titletext: {Title}
:doctype: book
:encoding: utf-8
:lang: en
...
|Approval Date:   <2020-mm-dd>
|Publication Date:   <2020-mm-dd>
|External identifier of this OGC(R) document: http://www.opengis.net/doc/IS/cdb-geopackage/1.2
|Internal reference number of this OGC(R) document:    19-054
|Version: 1.2
|Category: OGC(R) Draft Implementation Standard
|Editor:   Carl Reed, others
|===
