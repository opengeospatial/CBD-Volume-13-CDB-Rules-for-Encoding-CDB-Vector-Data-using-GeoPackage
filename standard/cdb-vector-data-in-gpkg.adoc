...
|External identifier of this OGC(R) document: http://www.opengis.net/doc/IS/cdb-geopackage/1.3
|Internal reference number of this OGC(R) document:    20-050-054 ?? 19-054r?
|Version: 1.2
