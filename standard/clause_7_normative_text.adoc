...
To ensure interoperability, file names and literal strings need to follow the case rules identified in both teh CDB and GeoPackage Standards. The following requirement speciffies the literal case rules.

include::requirements/REQ0012.adoc[]
