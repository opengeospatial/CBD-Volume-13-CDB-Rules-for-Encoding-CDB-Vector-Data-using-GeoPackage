...
This optional OGC CDB 2.0 Application Profile defines the requirements and provides CDB specific guidance on using GeoPackage containers in a CDB 2.0 data store. A number of requirements in this Application Profile are restrictions of requirements specified in the CDB 2.0 Core Requirements Module.
